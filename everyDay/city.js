...
// // {
// //   arrCity[i].sub.indexOf('请选择') ="xx";
// // }

// arrCity.forEach(function(item,index,array){
...
function change(array)
{
    ...
    for(var i=0; i<array.length; i++)
    {
        ...
        if(array[i].hasOwnProperty('sub'))
        {
            array[i].sub[0].name = 'please choose';
            //array[i].sub[1].name = 'please choose';
        }
...
var citys = change(arrCity);
console.log(JSON.stringify(citys));


//var citys = JSON.stringify(arrCity);
//var newCitys = citys.replace(/"请选择"/g,'please choose');


//var x = eval('('+newCitys+')');
//console.log(x);
//console.log(JSON.parse(newCitys));
