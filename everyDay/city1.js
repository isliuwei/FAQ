...
function change(array)
{
    ...
    for(var i=0; i<array.length; i++)
    {
        ...
        if(array[i].hasOwnProperty('sub'))//array[i]
        {
            ...
            for(var j=0; j<array[i].sub.length;j++)
            {
            	...
            	if(array[i].sub[j].hasOwnProperty('sub'))
            	{
            		//array[i].sub[j].sub="xx";

            		if(array[i].sub[j].sub[0])
            		{
            			array[i].sub[j].sub[0].name='please choose';
            		}
            	}
